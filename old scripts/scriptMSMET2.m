...
% Alert sent to this email when job finishes
...
if(neuroecon==1)
	...
	%Log file location
	lognamebase = fullfile('C:','log',jobname);
	%Core dir (images location)
	dire = 'C:\Documents and Settings\collinyu\My Documents\MATLAB';
	%NIFTIpath
	niftpath = 'C:\Documents and Settings\collinyu\My Documents\MATLAB\niftitools';
	%Where the scripts are
	scriptspath = '/data/scripts/RARET1';
end
...
sendmail(email,'T2 star map Processing completed',['Hello! Your T2 job is done! ' ...
